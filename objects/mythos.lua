...
SMODS.Consumable({
    ...
    pos = {x=3, y=0},
    discovered = false,
    config = {extra = {select = 6, curse = 'ortalab_all_curses', method = 'c_ortalab_mult_random', choose = 1, copies = 3}},
    artist_credits = {'gappie'},
    loc_vars = function(self, info_queue, card)
...
SMODS.Consumable({
    ...
    pos = {x=0, y=2},
    discovered = false,
    config = {extra = {select = 4, scale = 2, curse = 'ortalab_possessed', method = 'c_ortalab_mult_random', handsize = 1}},
    artist_credits = {'gappie'},
    loc_vars = function(self, info_queue, card)
        info_queue[#info_queue + 1] = {set = 'Curse', key = card.ability.extra.curse}
